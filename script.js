...
const firebaseConfig = {
  apiKey: "AIzaSyCKOoS6y20TlzhngBmwMWVlnGFdwyF92JU",
  authDomain: "leclaireuntalanportfolio-afb65.firebaseapp.com",
  databaseURL: "https://leclaireuntalanportfolio-afb65-default-rtdb.firebaseio.com",
  projectId: "leclaireuntalanportfolio-afb65",
  storageBucket: "leclaireuntalanportfolio-afb65.appspot.com",
  messagingSenderId: "387985625299",
  appId: "1:387985625299:web:b943b3b081272e02510426",
  measurementId: "G-7W7LLPC7YG"
};
...
document.querySelectorAll(".reaction-btn").forEach((button) => {
  const blogId = button.dataset.blog;         // ex: "1"
  const reaction = button.dataset.reaction;   // "like" or "heart"

  const countSpan = button.querySelector(".reaction-count");

  // Create Firebase path: likes/blog1/like or likes/blog2/heart etc.
  const reactionRef = database.ref(`likes/blog${blogId}/${reaction}`);
